    ...
    <div class="mx-auto max-w-7xl px-5 py-10 sm:px-6 lg:px-8">
        <div class="flex flex-col justify-between gap-6 sm:flex-row sm:items-end">
            <div>
                ...
                <p class="mt-3 max-w-md text-sm leading-6 text-slate-500">A clear, secure way to confirm the status of QR-linked immigration documents.</p>
            </div>
        ...
        <div class="mt-8 border-t border-slate-100 pt-5 text-xs text-slate-400">&copy; {{ date('Y') }} MigraVerify. Secure document verification.</div>
    </div>
</footer>
