...
@section('title', 'Verified document | MigraVerify')
...
<section class="min-h-[70vh] bg-slate-50 py-12 sm:py-16">
    <div class="mx-auto max-w-5xl px-5 sm:px-6 lg:px-8">
        <a href="{{ route('home') }}" class="inline-flex items-center gap-2 text-sm font-bold text-slate-600 transition hover:text-sky-700"><svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m15 18-6-6 6-6"/></svg>Back to MigraVerify</a>
